...
// +++++++++++++ Interesting  Concept of Functions +++++++++++++++++++++
// Since Function Can be declared as a Varible with Var_name as Function name

addone(7) // we can ACCESS a function before its declaration when declared normally or this method gives no ERROR
function addone(num){
    console.log(num+1); // o/p-> 8
}
// But if we declare function as variable lets see what happens

addTwo(6) // O/p-> ReferenceError as we Cannot ACCESS a Function(When declared as variable) before its    Defination
